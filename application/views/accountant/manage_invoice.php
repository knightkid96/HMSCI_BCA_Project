                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" name="method" value="<?php echo $row['method'];?>"/>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center"><?php echo 'Rs'.$row['amount'];?></td>

                            <td class="center"><?php echo '->'.$row['method'];?></td>
                            ...
                            <td class="center">
                                ...
                                <?php if($row['status']=='unpaid'):?>
                                    ...
                                    <?php echo form_open('accountant/take_cash_payment' , array(
										...
										'onsubmit' => "return confirm('Confirm payment verification? It will mark this invoice as paid')"));?>
                                        	...
                                        	<input name="method" 		type="hidden" value="<?php echo $row['method'];?>" />

                                        	<input name="description" 	type="hidden" value="<?php echo $row['description'];?>" />

                                        	<input name="amount" 		type="hidden" value="<?php echo $row['amount'];?>" />

                                    		<input name="" type="submit" value="<?php echo ('Verify Payment');?>" class="btn btn-gray btn-mini"/>
